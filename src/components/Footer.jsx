          ...
          <div className="grid inset-x-0 grid-cols-1 gap-8 sm:gap-2 sm:grid-cols-3 text-left sm:text-center ">
              ...
              <ul className="text-gray-500 font-photograph grid grid-cols-2 sm:grid-cols-1">
                ...
                <li>
                  ...
                  {showFinancialReports && (<ul type="circle" className='text-[#F1EFE2]'>
                    <li className='sm:text-base text-[#F1EFE2] font-photograph text-xl lg:text-xl hover:text-[#2DA2DD]'><a href="/assets/Documents/EtatsFin_23-24.pdf" target="_blank" without rel="noreferrer" >2023-2024</a> </li>
                    <li className='sm:text-base text-[#F1EFE2] font-photograph text-xl lg:text-xl hover:text-[#2DA2DD]'><a href="/assets/Documents/ENSI JE Rapport CAC des EFs arrêtés le 30-06-2023.pdf" target="_blank" without rel="noreferrer" >2022-2023</a></li>
                  </ul>)}
                </li>
              </ul>
            ...
            <div className='sm:pr-12'>
              ...
              <ul className="text-gray-500  font-medium">
                ...
                <li>
                  <a href="#" className="sm:text-base hover:underline text-[#F1EFE2] lg:text-xl font-photograph text-xl ">+216 44 412 115</a>
                </li>
                <li className='mt-4'>
                  <div className="flex sm:justify-center justify-start gap-6 ">
                    <a className="text-[#1F2029] " aria-label="Visit TrendyMinds LinkedIn" href="https://www.linkedin.com/company/ensi-junior-entreprise/mycompany/" target="_blank">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="h-7 w-7 bg-[#2DA2DD] rounded p-[1px]">
                    ...
                    <a className="text-[#1F2029] " aria-label="Visit TrendyMinds Facebook" href="https://www.facebook.com/ENSI.Junior.Entreprise" target="_blank">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" className="h-7 w-7 bg-[#2DA2DD] rounded p-[1px]">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"viewBox="0 0 256 180" className="h-7 w-7 bg-[#2DA2DD] rounded p-[1px]">
                    <path fill="#1F2029" d="M250.346 28.075A32.18 32.18 0 0 0 227.69 5.418C207.824 0 127.87 0 127.87 0S47.912.164 28.046 5.582A32.18 32.18 0 0 0 5.39 28.24c-6.009 35.298-8.34 89.084.165 122.97a32.18 32.18 0 0 0 22.656 22.657c19.866 5.418 99.822 5.418 99.822 5.418s79.955 0 99.82-5.418a32.18 32.18 0 0 0 22.657-22.657c6.338-35.348 8.291-89.1-.164-123.134"/>
                    <path fill="#2DA2DD" d="m102.421 128.06l66.328-38.418l-66.328-38.418z"/></svg>
                    </a>
