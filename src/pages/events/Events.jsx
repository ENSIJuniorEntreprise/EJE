...
function Events() {
  ...
  return (
    <div>
      <section className="flex items-center justify-center bg-cover bg-center md:h-[550px] xxs:h-[450px]" style={{ backgroundImage: `url(${gete})`, backgroundPositionY:"50%", }}>
        <div
